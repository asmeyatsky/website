            ...
            <form onSubmit={handleNewsletterSignup} className="space-y-3">
              <div className="flex gap-2 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 bg-primary-dark/50 border border-primary-accent/30 rounded-lg px-4 py-3 text-primary-text placeholder-primary-text/40 focus:outline-none focus:border-primary-accent transition-colors duration-300 disabled:opacity-50"
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
